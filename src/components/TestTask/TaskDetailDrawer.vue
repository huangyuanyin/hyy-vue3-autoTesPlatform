  ...
  >
    ...
    <template #default>
      ...
      >
        ...
        <el-form-item label="" v-show="taskDetailForm.serverName">
        ...
        <el-form-item label="全量基线版本列表" prop="deployVersion" v-show="taskDetailForm.deployType === 'full'">
        ...
        <el-form-item label="项目基线版本列表" prop="patchVersion" v-show="taskDetailForm.deployType === 'baseline'">
        ...
        <el-form-item label="开机自启中间件" prop="startMidwareType" v-show="taskDetailForm.main_bord_type === 'x86'">
        ...
        <el-form-item label="是否生产部门安装" prop="ifback" v-show="taskDetailForm.deployType === 'baseline'">
          <el-radio-group v-model="taskDetailForm.ifback" class="ml-4">
            <el-radio label="y">是</el-radio>
            <el-radio label="n">否</el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item label="是否重启服务" prop="ifrs" v-show="taskDetailForm.deployType === 'baseline'">
